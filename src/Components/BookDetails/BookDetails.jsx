    ...
    <div className='pt-5 pb-10'>
      <div className="container mx-auto px-3">
        <div className='grid md:grid-cols-2 gap-4'>
          <div className='bg-gray-100 px-4 py-8 rounded-xl mb-4 flex items-center justify-center'>
          ...
          <div className='px-3'>
            ...
            <div className='flex items-center justify-between pt-2 borderdashed border-b border-gray-200 py-2'>
            ...
            <div className='space-y-2 pt-2'>
              ...
              <div className='grid grid-cols-3 gap-2'>
                <p>Rating:</p>
                <strong className='col-span-2'>{rating}</strong>
              </div>
            </div>
